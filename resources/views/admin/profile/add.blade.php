                            ...
                            <div class="card-body">
                                <form class="" action="{{ route('profile.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" name="m_name" type="text" id="default-input" placeholder="Input Name">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Designation</label>
                                        <input class="form-control" name="designation" type="text" id="default-input" placeholder="Input Author Name">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Designation-2</label>
                                        <input class="form-control" name="f_designation" type="text" id="default-input" placeholder="Input Author Name">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Designation-3</label>
                                        <input class="form-control" name="s_designation" type="text" id="default-input" placeholder="Input Author Name">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="form-sm-input">Short Description</label>
                                        <textarea class="form-control form-control-sm" type="text" name="s_description" placeholder="Write Desc...."></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="form-sm-input">Description</label>
                                        <textarea class="form-control form-control-sm" id="ckeditor-classic" type="text" name="m_description" placeholder="Write Desc...."></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Note</label>
                                        <input class="form-control" name="note" type="text" id="default-input" placeholder="Input NOte">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" name="fb_url" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">LinkedIn URL</label>
                                        <input class="form-control" name="linked_in_url" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">GitHub URL</label>
                                        <input class="form-control" name="git_url" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Phone</label>
                                        <input class="form-control" name="phone" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Email</label>
                                        <input class="form-control" name="email" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">CopyRight</label>
                                        <input class="form-control" name="copy_right" type="text" id="default-input" placeholder="Input Slug">
                                    </div>
                                    <div class="mb-4">
