                            ...
                            <div class="card-body">
                                <form class="" action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input class="form-control" name="t_name" type="text" id="default-input" placeholder="Input Team Member name">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">Team Member Designation</label>
                                        <input class="form-control" name="designation" type="text" id="default-input" placeholder="Input His/Her Designation">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">His/her Facebook URL</label>
                                        <input class="form-control" name="t_fburl" type="text" id="default-input" placeholder="Input His/Her Facebook URl">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">His/her GitHub URL</label>
                                        <input class="form-control" name="t_github" type="text" id="default-input" placeholder="Input His/Her GitHub URl">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">His/her LinkedIn URL</label>
                                        <input class="form-control" name="t_linked" type="text" id="default-input" placeholder="Input His/Her LinkedIn URl">
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label" for="default-input">His/her Website URL</label>
                                        <input class="form-control" name="web_url" type="text" id="default-input" placeholder="Input His/Her Website URl">
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <button class="btn btn-primary ms-auto" type="submit">Save Team Info</button>
                                    </div>
                                </form>
                            </div>
                        </div>
