        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('dashboard') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset($profiles->main_logo) }}" alt="" height="40">
                                </span>
                    <span class="logo-lg">
                                    <img src="{{ asset($profiles->main_logo) }}" alt="" height="40"> <span class="logo-txt">{{ $profiles->m_name }}</span>
                                </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end" id="page-header-user-dropdown"
                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset($profiles->main_logo) }}"
                         alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ $profiles->m_name }}</span>
